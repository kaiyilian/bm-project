...
'use strict';
//"/admin/corporation/bus/preview/html?suffix=.pdf";
// debug

var DEFAULT_URL = localStorage.getItem('contextPath') + JSON.parse(localStorage.getItem('pdfUrl'))[localStorage.getItem('pdfUrlKey')];
console.log("path: " + DEFAULT_URL);
