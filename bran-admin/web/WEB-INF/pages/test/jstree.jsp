...
<head>
    ...
    <!--[if lt IE 9]><script src="//static.jstree.com/3.3.1/assets/html5.js"></script><![endif]-->

    <meta name="robots" content="index,follow" />
    <link rel="stylesheet" href="//static.jstree.com/3.3.1/assets/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" href="//static.jstree.com/3.3.1/assets/dist/themes/default/style.min.css" />
    <%--<link rel="stylesheet" href="//static.jstree.com/3.3.1/assets/docs.css" />--%>
    <!--[if lt IE 9]><!--<script src="//static.jstree.com/3.3.1/assets/respond.js"></script>--><![endif]-->

    <%--<link rel="icon" href="//static.jstree.com/3.3.1/assets/favicon.ico" type="image/x-icon" />--%>
    <%--<link rel="apple-touch-icon-precomposed" href="//static.jstree.com/3.3.1/assets/apple-touch-icon-precomposed.png" />--%>
    ...
    <%--<div class="container">--%>
        <%--<div class="row">--%>
            <%--<div class="col-md-3 col-sm-12">--%>
                <%--<h1 id="logo"><a href="//jstree.com">jsTree - jQuery tree plugin<span>3.3.1</span></a></h1>--%>
            <%--</div>--%>
...
<script src="//static.jstree.com/3.3.1/assets/jquery-1.10.2.min.js"></script>
<script src="//static.jstree.com/3.3.1/assets/jquery.address-1.6.js"></script>
<script src="//static.jstree.com/3.3.1/assets/vakata.js"></script>
<script src="//static.jstree.com/3.3.1/assets/dist/jstree.min.js"></script>
