...
<%--本页面--%>
<script src="<%=contextPath%>/js/bran/employee/emp_prospective_detail.js"></script>

<div class="emp_prospective_detail_container detail_container">
	...
	<div class="head">
        ...
        <span class="btn_list">
            <span class="btn btn-small btn-orange btn_down"
				  onclick="emp_prospective_detail.enclosureDown() ">下载附件</span>
            <span class="btn btn-small btn-orange btn_degree"
				  onclick="emp_prospective_detail.entryOnly(this)">同意入职</span>
        </span>
