...
<%--本页面--%>
<link href="<%=contextPath%>/css/bran/employee/emp_prospective_test.css" rel="stylesheet">
<script src="<%=contextPath%>/js/bran/employee/emp_prospective_test.js"></script>
...
<div class="import_container emp_import_container">
    ...
    <div class="item pull-right col-xs-2 btn_emp_info_set" onclick="emp_info_set.empInfoSetModalShow();">
        <i class="icon icon-emp_emp_info_set"></i>
        <div class="txt">入职信息配置</div>
    </div>
    ...
    <div class="foot">
        ...
        <div class="btn_list">
            ...
            <div class="btn btn-sm btn-success btn_export"
                 onclick="emp_prospective.exportEmpList()">导出
            </div>
...
<div class="modal fade emp_info_set_modal" style="background-color:rgba(0,0,0,0.50);">
    <div class="modal-dialog" style="">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">入职信息配置</h4>
            </div>
            <div class="modal-body">

                <div class="row emp_info_set_list">

                    <div class="col-xs-4 item">

                        <img src="image/default_choose.png">
                        <span>身份证信息</span>
                        <img src="image/icon_contract/icon_msg.png" class="icon_msg"
                             data-html="true"
                             data-toggle="tooltip"
                             data-placement="top"
                             title="<p>信息包括：身份证信息、人脸识别、基本信息、银行卡信息、学历信息和工作经历；</p>"/>

                    </div>

                    <div class="col-xs-4 item face_info">
                    ...
                    <div class="col-xs-4 item base_info">
                    ...
                    <div class="col-xs-4 item bank_info">
                    ...
                    <div class="col-xs-4 item edu_info">
                    ...
                    <div class="col-xs-4 item work_info">
                ...
                <div class="txt">
                    注：请勾选员工入职时需要录入的信息，勾选后的信息均为必填。
                </div>

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-success" onclick="emp_info_set.empInfoSave()">保存</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
