 ...
 */
@ApiModel
public class ProjectApplyUpdateCommand implements EntityConverter<ProjectApplyEntity>,VoConverterFunction.Add<ProjectApplyEntity, SessionInfo>{

    @ApiModelProperty(value = "立项申请ID", name = "id")
    @NotBlank
    private String id;
    ...
    public void begin(ProjectApplyEntity projectApplyEntity, SessionInfo info) {
        projectApplyEntity.setIsCustomer(Constants.FALSE);
    ...
    public String toString() {
        return "ProjectApplyUpdateCommand{" +
                "id='" + id + '\'' +
                ", salesMan='" + salesMan + '\'' +
