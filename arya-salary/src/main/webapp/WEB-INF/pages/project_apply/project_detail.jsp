...
<link href="<%=contextPath%>/css/arya/project_apply/project_detail.css" rel="stylesheet"/>
<script src="<%=contextPath%>/js/arya/project_apply/project_detail.js"></script>

<div class="container project_detail_container">

    <div class="head border-bottom">
        <div class="txt">立项申请 - 详情</div>
    </div>
    ...
    <div class="content">
        ...
        <div class="btn_list">
            ...
            <div class="btn btn-primary btn_modify" onclick="project_detail.projectModify()">编辑</div>
            <div class="btn btn-primary btn_save" onclick="project_detail.projectSave()">保存</div>
            <div class="btn btn-default btn_cancel" onclick="project_detail.projectCancel()">取消</div>
        ...
        <div class="table_container">
            ...
            <div class="btn btn-primary btn_add" onclick="project_detail.recordModalShow()">添加跟进记录</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="project_detail.recordAdd()">
                        确定
                    </button>
                </div>
            </div>
