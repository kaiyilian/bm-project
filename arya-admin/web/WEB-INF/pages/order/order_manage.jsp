...
<%--本页面--%>
<script src="<%=contextPath%>/js/order/order_manage.js"></script>
<link href="<%=contextPath%>/css/order/order_manage.css" rel="stylesheet"/>

<div class="order_manage_container container">
	...
	<div class="content">
		...
		<div class="search_container">
			...
			<div class="input-group col-xs-3 item">
				...
				<input class="form-control soin_area" type="text" readonly value="请选择地区"
					   data-district_id="" onclick="order_manage.SoinAreaModalShow()"/>
			</div>
			...
			<div class="btn_list">
				...
				<span class="btn btn-sm btn-primary btn_search"
					  onclick="order_manage.btnSearchClick()">查询
				</span>

                <span class="btn btn-sm btn-primary btn_reset"
					  onclick="order_manage.initSearchCondition()">重置
				</span>
		...
		<div class="table_container">
			<table class="table table-striped table-bordered table-hover dataTable">
				<thead>
				<tr>
					<td class="choose_item" onclick="order_manage.chooseCurAll()">
					...
					<td>
						业务员
						<div class="sort_list" data-sortName="salesmanName">
							<img src="img/icon_sort.png" class="sorting_asc" data-sort="1">
							<img src="img/icon_sort.png" class="sorting_desc" data-sort="2">
						</div>
					</td>
					<td>
						供应商
						<div class="sort_list" data-sortName="supplierId">
							<img src="img/icon_sort.png" class="sorting_asc" data-sort="1">
							<img src="img/icon_sort.png" class="sorting_desc" data-sort="2">
						</div>
					</td>
	...
	<div class="foot">
		...
		<div class="btn_list">
			...
			<div class="btn btn-sm  btn-primary btn_modify"
				 onclick="order_manage.orderModifyModalShow()">
				批量修改
			</div>

			<div class="btn btn-sm  btn-primary btn_export"
				 onclick="order_manage.orderExport()">
				导出全部
			</div>
...
<div class="modal fade soin_area_modal" style="background-color:rgba(0,0,0,0.50);">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="ztree soin_all_area_tree" id="soin_all_area_tree"></div>

			</div>
			<div class="modal-footer">
				<%--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>--%>
				<button type="button" class="btn btn-primary"
						onclick="order_manage.SoinAreaSure()">确定
				</button>
			</div>
		</div>
		<!-- /.modal-content -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<%--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>--%>
				<button type="button" class="btn btn-primary"
						onclick="order_manage.payFailAllSure()">确定
				</button>
			</div>
		</div>
		<!-- /.modal-content -->
...
<div class="modal fade order_detail_modal" style="background-color:rgba(0,0,0,0.50);">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<table class="table table-bordered dataTable">
					...
					<tr class="item">
						<td>明细（元）</td>
						<td class="disabilityTotal npt_val">
							<div>0</div>
						</td>
						<td class="serverIllnessTotal npt_val">
							<div>0</div>
						</td>
						<td class="injuryAdditionTotal npt_val">
							<div>0</div>
						</td>
						<td class="heatingTotal npt_val">
							<div>0</div>
						</td>
						<td class="houseFundAdditionTotal npt_val">
							<div>0</div>
						</td>
					</tr>
			...
			<div class="modal-footer">
				<%--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>--%>
				<button type="button" class="btn btn-primary"
						onclick="order_manage.orderSaveByModify()">
					确定
				</button>
			</div>
		</div>
